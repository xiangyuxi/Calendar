...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     */
    return [self.delegate ybPopupMenuWithTableView:self.tableView image:[UIImage imageNamed:_images[indexPath.row]] title:_titles[indexPath.row]];
}
...
{
    YBPTableViewCell *cell = [self getLastVisibleCell];
}
...
- (void)setDefaultSettings
{
    ...
    _menuBackView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.4];
    _menuBackView.alpha = 0;
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        _tableView.layer.masksToBounds =
